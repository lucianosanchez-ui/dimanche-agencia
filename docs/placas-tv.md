...
**BUDINES (producto, video 12s) — PRODUCIDA 10/06, esperando aprobación final de Luciano.** 3 actos: (1) hero chocolatoso cortado sobre crema (clip Seedance 1080p) + "el que te salva / [la juntada]"; (2) cenitales VERTICALES de a uno (1s c/u, nano_banana desenvolvió los 6 desde la cenital real IMG_9603), nombre al lado; (3) cierre: los 6 en fila + "$4.500 — el que sea" + "los mates los pone otro." + sello. Primera placa de producto sobre CREMA. Entregados: `budines — video (12s).mp4` + `budines — placa estatica.png` (= still frame 355). Comp `BudinesVideo` (`PlacaBudinesVideo.tsx`); assets en `public/media/tv/budines/` (gitignored — backup en `_opciones budines/generaciones-ia/`). Generaciones: 9 nano_banana (1 corrección chocolatoso: masa chocolate + glaseado a borde) + 2 Seedance (la 720p de descarte; quedó la 1080p job 977ae7dc).
